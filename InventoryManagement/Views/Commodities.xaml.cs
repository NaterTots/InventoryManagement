...
{
    public partial class Commodities : UserControl, ICleanup
    {
        ...
        public Commodities()
        {
            ...
            commodityEditorContentControl.Content = new CommodityEditor();
            ...
            if (!ViewModelBase.IsInDesignModeStatic)
            {
                ...
                _viewModelExport = App.Container.GetExport<ViewModelBase>(
                    ViewModelTypes.CommoditiesViewModel);
        ...
        public void Cleanup()
        {
            ...
            var workOrderEditor = commodityEditorContentControl.Content as ICleanup;
            if (workOrderEditor != null)
                workOrderEditor.Cleanup();
            commodityEditorContentControl.Content = null;
            // cleanup itself
