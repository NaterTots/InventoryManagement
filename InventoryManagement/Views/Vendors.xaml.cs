...
{
    public partial class Vendors : UserControl, ICleanup
    {
        ...
        public Vendors()
        {
            ...
            vendorEditorContentControl.Content = new CommodityEditor();
            ...
            if (!ViewModelBase.IsInDesignModeStatic)
            {
                ...
                _viewModelExport = App.Container.GetExport<ViewModelBase>(
                    ViewModelTypes.VendorsViewModel);
        ...
        public void Cleanup()
        {
            ...
            var workOrderEditor = vendorEditorContentControl.Content as ICleanup;
            if (workOrderEditor != null)
                workOrderEditor.Cleanup();
            vendorEditorContentControl.Content = null;
            // cleanup itself
